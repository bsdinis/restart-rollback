...
inline const MessageType (&EnumValuesMessageType())[19] {
    static const MessageType values[] = {
        ...
        MessageType_get_timestamp_resp, MessageType_change_policy_req,
...
template <>
struct BasicMessageTraits<teems::ProxyPutArgs> {
    static const BasicMessage enum_value = BasicMessage_ProxyPutArgs;
};

template <>
struct BasicMessageTraits<teems::PutArgs> {
...
template <>
struct BasicMessageTraits<teems::StabilizeArgs> {
    static const BasicMessage enum_value = BasicMessage_StabilizeArgs;
};

template <>
struct BasicMessageTraits<teems::Empty> {
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) Policy FLATBUFFERS_FINAL_CLASS {
   ...
   public:
    ...
    int32_t owner_id() const { return flatbuffers::EndianScalar(owner_id_); }
...
struct GetResultBuilder {
    ...
    void add_policy_version(int64_t policy_version) {
        fbb_.AddElement<int64_t>(GetResult::VT_POLICY_VERSION, policy_version,
                                 0);
    }
...
inline flatbuffers::Offset<ProxyPutArgs> CreateProxyPutArgs(
    flatbuffers::FlatBufferBuilder &_fbb, int64_t key = 0,
    const teems::Value *value = 0, int32_t client_id = 0) {
...
struct PutResultBuilder {
    ...
    void add_policy_version(int64_t policy_version) {
        fbb_.AddElement<int64_t>(PutResult::VT_POLICY_VERSION, policy_version,
                                 0);
    }
    void add_timestamp(int64_t timestamp) {
...
struct StabilizeArgsBuilder {
    ...
    void add_policy_version(int64_t policy_version) {
        fbb_.AddElement<int64_t>(StabilizeArgs::VT_POLICY_VERSION,
                                 policy_version, 0);
    }
    void add_timestamp(int64_t timestamp) {
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    teems::BasicMessage message_type() const {
        return static_cast<teems::BasicMessage>(
    ...
    const teems::GetArgs *message_as_GetArgs() const {
        return message_type() == teems::BasicMessage_GetArgs
                   ? static_cast<const teems::GetArgs *>(message())
                   : nullptr;
    }
    const teems::GetResult *message_as_GetResult() const {
        return message_type() == teems::BasicMessage_GetResult
                   ? static_cast<const teems::GetResult *>(message())
                   : nullptr;
    }
    const teems::GetTimestampArgs *message_as_GetTimestampArgs() const {
        return message_type() == teems::BasicMessage_GetTimestampArgs
                   ? static_cast<const teems::GetTimestampArgs *>(message())
                   : nullptr;
    }
    const teems::GetTimestampResult *message_as_GetTimestampResult() const {
        return message_type() == teems::BasicMessage_GetTimestampResult
    ...
    const teems::PutArgs *message_as_PutArgs() const {
        return message_type() == teems::BasicMessage_PutArgs
                   ? static_cast<const teems::PutArgs *>(message())
                   : nullptr;
    }
    const teems::PutResult *message_as_PutResult() const {
        return message_type() == teems::BasicMessage_PutResult
    ...
    const teems::Empty *message_as_Empty() const {
        return message_type() == teems::BasicMessage_Empty
                   ? static_cast<const teems::Empty *>(message())
                   : nullptr;
    }
...
template <>
inline const teems::GetArgs *Message::message_as<teems::GetArgs>() const {
    return message_as_GetArgs();
}

template <>
inline const teems::GetResult *Message::message_as<teems::GetResult>() const {
    return message_as_GetResult();
}

template <>
inline const teems::GetTimestampArgs *
Message::message_as<teems::GetTimestampArgs>() const {
...
template <>
inline const teems::ProxyPutArgs *Message::message_as<teems::ProxyPutArgs>()
    const {
    return message_as_ProxyPutArgs();
}

template <>
inline const teems::PutArgs *Message::message_as<teems::PutArgs>() const {
...
template <>
inline const teems::StabilizeArgs *Message::message_as<teems::StabilizeArgs>()
    const {
    return message_as_StabilizeArgs();
}

template <>
inline const teems::Empty *Message::message_as<teems::Empty>() const {
