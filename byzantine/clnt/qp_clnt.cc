...
int close(bool close_remote) {
    ...
    if (close_remote) {
        ...
        auto close_args = register_sgx::byzantine::CreateEmpty(builder);
        auto request = register_sgx::byzantine::CreateMessage(
            builder, register_sgx::byzantine::MessageType_close_req, ticket,
            register_sgx::byzantine::BasicMessage_Empty, close_args.Union());
