...
template<> struct BasicMessageTraits<register_sgx::byzantine::Greeting> {
  static const BasicMessage enum_value = BasicMessage_Greeting;
};

template<> struct BasicMessageTraits<register_sgx::byzantine::GetArgs> {
  static const BasicMessage enum_value = BasicMessage_GetArgs;
};

template<> struct BasicMessageTraits<register_sgx::byzantine::GetResult> {
  static const BasicMessage enum_value = BasicMessage_GetResult;
};

template<> struct BasicMessageTraits<register_sgx::byzantine::GetTimestampArgs> {
  static const BasicMessage enum_value = BasicMessage_GetTimestampArgs;
};

template<> struct BasicMessageTraits<register_sgx::byzantine::GetTimestampResult> {
  static const BasicMessage enum_value = BasicMessage_GetTimestampResult;
};

template<> struct BasicMessageTraits<register_sgx::byzantine::ProxyPutArgs> {
  static const BasicMessage enum_value = BasicMessage_ProxyPutArgs;
};

template<> struct BasicMessageTraits<register_sgx::byzantine::PutArgs> {
  static const BasicMessage enum_value = BasicMessage_PutArgs;
};

template<> struct BasicMessageTraits<register_sgx::byzantine::PutResult> {
  static const BasicMessage enum_value = BasicMessage_PutResult;
};

template<> struct BasicMessageTraits<register_sgx::byzantine::Empty> {
...
struct Value FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const register_sgx::byzantine::DataValue *data_value() const {
    return GetStruct<const register_sgx::byzantine::DataValue *>(VT_DATA_VALUE);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<register_sgx::byzantine::DataValue>(verifier, VT_DATA_VALUE) &&
...
inline flatbuffers::Offset<SignedValue> CreateSignedValueDirect(
  ...
  return register_sgx::byzantine::CreateSignedValue(
      _fbb,
      value,
      signature__);
}
...
struct GetResult FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const register_sgx::byzantine::SignedValue *signed_value() const {
    return GetPointer<const register_sgx::byzantine::SignedValue *>(VT_SIGNED_VALUE);
  }
  register_sgx::byzantine::SignedValue *mutable_signed_value() {
    return GetPointer<register_sgx::byzantine::SignedValue *>(VT_SIGNED_VALUE);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_SIGNED_VALUE) &&
           verifier.VerifyTable(signed_value()) &&
           verifier.EndTable();
  }
};
...
struct GetResultBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_signed_value(flatbuffers::Offset<register_sgx::byzantine::SignedValue> signed_value) {
...
inline flatbuffers::Offset<GetResult> CreateGetResult(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<register_sgx::byzantine::SignedValue> signed_value = 0) {
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  register_sgx::byzantine::MessageType type() const {
    return static_cast<register_sgx::byzantine::MessageType>(GetField<int8_t>(VT_TYPE, 0));
  }
  ...
  register_sgx::byzantine::BasicMessage message_type() const {
    return static_cast<register_sgx::byzantine::BasicMessage>(GetField<uint8_t>(VT_MESSAGE_TYPE, 0));
  }
  ...
  const register_sgx::byzantine::Greeting *message_as_Greeting() const {
    return message_type() == register_sgx::byzantine::BasicMessage_Greeting ? static_cast<const register_sgx::byzantine::Greeting *>(message()) : nullptr;
  }
  const register_sgx::byzantine::GetArgs *message_as_GetArgs() const {
    return message_type() == register_sgx::byzantine::BasicMessage_GetArgs ? static_cast<const register_sgx::byzantine::GetArgs *>(message()) : nullptr;
  }
  const register_sgx::byzantine::GetResult *message_as_GetResult() const {
    return message_type() == register_sgx::byzantine::BasicMessage_GetResult ? static_cast<const register_sgx::byzantine::GetResult *>(message()) : nullptr;
  }
  const register_sgx::byzantine::GetTimestampArgs *message_as_GetTimestampArgs() const {
    return message_type() == register_sgx::byzantine::BasicMessage_GetTimestampArgs ? static_cast<const register_sgx::byzantine::GetTimestampArgs *>(message()) : nullptr;
  }
  const register_sgx::byzantine::GetTimestampResult *message_as_GetTimestampResult() const {
    return message_type() == register_sgx::byzantine::BasicMessage_GetTimestampResult ? static_cast<const register_sgx::byzantine::GetTimestampResult *>(message()) : nullptr;
  }
  const register_sgx::byzantine::ProxyPutArgs *message_as_ProxyPutArgs() const {
    return message_type() == register_sgx::byzantine::BasicMessage_ProxyPutArgs ? static_cast<const register_sgx::byzantine::ProxyPutArgs *>(message()) : nullptr;
  }
  const register_sgx::byzantine::PutArgs *message_as_PutArgs() const {
    return message_type() == register_sgx::byzantine::BasicMessage_PutArgs ? static_cast<const register_sgx::byzantine::PutArgs *>(message()) : nullptr;
  }
  const register_sgx::byzantine::PutResult *message_as_PutResult() const {
    return message_type() == register_sgx::byzantine::BasicMessage_PutResult ? static_cast<const register_sgx::byzantine::PutResult *>(message()) : nullptr;
  }
  const register_sgx::byzantine::Empty *message_as_Empty() const {
    return message_type() == register_sgx::byzantine::BasicMessage_Empty ? static_cast<const register_sgx::byzantine::Empty *>(message()) : nullptr;
  }
...
template<> inline const register_sgx::byzantine::Greeting *Message::message_as<register_sgx::byzantine::Greeting>() const {
  return message_as_Greeting();
}

template<> inline const register_sgx::byzantine::GetArgs *Message::message_as<register_sgx::byzantine::GetArgs>() const {
  return message_as_GetArgs();
}

template<> inline const register_sgx::byzantine::GetResult *Message::message_as<register_sgx::byzantine::GetResult>() const {
  return message_as_GetResult();
}

template<> inline const register_sgx::byzantine::GetTimestampArgs *Message::message_as<register_sgx::byzantine::GetTimestampArgs>() const {
  return message_as_GetTimestampArgs();
}

template<> inline const register_sgx::byzantine::GetTimestampResult *Message::message_as<register_sgx::byzantine::GetTimestampResult>() const {
  return message_as_GetTimestampResult();
}

template<> inline const register_sgx::byzantine::ProxyPutArgs *Message::message_as<register_sgx::byzantine::ProxyPutArgs>() const {
  return message_as_ProxyPutArgs();
}

template<> inline const register_sgx::byzantine::PutArgs *Message::message_as<register_sgx::byzantine::PutArgs>() const {
  return message_as_PutArgs();
}

template<> inline const register_sgx::byzantine::PutResult *Message::message_as<register_sgx::byzantine::PutResult>() const {
  return message_as_PutResult();
}

template<> inline const register_sgx::byzantine::Empty *Message::message_as<register_sgx::byzantine::Empty>() const {
...
inline flatbuffers::Offset<Message> CreateMessage(
    flatbuffers::FlatBufferBuilder &_fbb,
    register_sgx::byzantine::MessageType type = register_sgx::byzantine::MessageType_client_greeting,
    int64_t ticket = 0,
    register_sgx::byzantine::BasicMessage message_type = register_sgx::byzantine::BasicMessage_NONE,
...
inline bool VerifyBasicMessage(flatbuffers::Verifier &verifier, const void *obj, BasicMessage type) {
  switch (type) {
    ...
    case BasicMessage_Greeting: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::Greeting *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_GetArgs: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::GetArgs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_GetResult: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::GetResult *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_GetTimestampArgs: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::GetTimestampArgs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_GetTimestampResult: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::GetTimestampResult *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_ProxyPutArgs: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::ProxyPutArgs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_PutArgs: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::PutArgs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_PutResult: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::PutResult *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_Empty: {
      auto ptr = reinterpret_cast<const register_sgx::byzantine::Empty *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline const register_sgx::byzantine::Message *GetSizePrefixedMessage(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<register_sgx::byzantine::Message>(buf);
}
...
inline bool VerifySizePrefixedMessageBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<register_sgx::byzantine::Message>(nullptr);
}
