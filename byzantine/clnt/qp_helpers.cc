...
int64_t send_get_request(int64_t key, call_type type) {
    ...
    auto get_args = register_sgx::byzantine::CreateGetArgs(builder, key);
...
int64_t send_get_timestamp_request(int64_t key, call_type type) {
    ...
    flatbuffers::FlatBufferBuilder builder;
    auto get_args =
        register_sgx::byzantine::CreateGetTimestampArgs(builder, key);
...
int64_t send_proxy_get_request(peer &server, int64_t key, call_type type) {
    ...
    auto request = register_sgx::byzantine::CreateMessage(
        builder, register_sgx::byzantine::MessageType_proxy_get_req, ticket,
        register_sgx::byzantine::BasicMessage_GetArgs, get_args.Union());
    builder.Finish(request);
...
int64_t send_proxy_put_request(peer &server, int64_t key,
    ...
    auto request = register_sgx::byzantine::CreateMessage(
        ...
        register_sgx::byzantine::BasicMessage_ProxyPutArgs, put_args.Union());
    builder.Finish(request);
...
int64_t send_ping_request(peer &server, call_type type) {
    ...
    flatbuffers::FlatBufferBuilder builder;
    auto ping_args = register_sgx::byzantine::CreateEmpty(builder);

    auto request = register_sgx::byzantine::CreateMessage(
        builder, register_sgx::byzantine::MessageType_ping_req, ticket,
...
int64_t send_reset_request(peer &server, call_type type) {
    ...
    flatbuffers::FlatBufferBuilder builder;
    auto reset_args = register_sgx::byzantine::CreateEmpty(builder);

    auto request = register_sgx::byzantine::CreateMessage(
        builder, register_sgx::byzantine::MessageType_reset_req, ticket,
        register_sgx::byzantine::BasicMessage_Empty, reset_args.Union());
    builder.Finish(request);
...
int handle_received_message(size_t idx, peer &p) {
    ...
    while (p.buffer().size() > 0) {
        ...
        switch (response->type()) {
            case register_sgx::byzantine::MessageType_client_greeting:
            ...
            case register_sgx::byzantine::MessageType_ping_resp:
                ...
                break;
            case register_sgx::byzantine::MessageType_reset_resp:
