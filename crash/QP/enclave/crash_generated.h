...
template <>
struct BasicMessageTraits<register_sgx::crash::Greeting> {
...
template <>
struct BasicMessageTraits<register_sgx::crash::ProxyPutArgs> {
...
inline flatbuffers::Offset<ProxyPutArgs> CreateProxyPutArgs(
    flatbuffers::FlatBufferBuilder &_fbb, int64_t key = 0,
    const register_sgx::crash::Value *value = 0, int32_t client_id = 0) {
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const register_sgx::crash::Greeting *message_as_Greeting() const {
        return message_type() == register_sgx::crash::BasicMessage_Greeting
                   ? static_cast<const register_sgx::crash::Greeting *>(
                         message())
                   : nullptr;
    }
    ...
    const register_sgx::crash::ProxyPutArgs *message_as_ProxyPutArgs() const {
        return message_type() == register_sgx::crash::BasicMessage_ProxyPutArgs
                   ? static_cast<const register_sgx::crash::ProxyPutArgs *>(
                         message())
                   : nullptr;
    }
...
template <>
inline const register_sgx::crash::Greeting *
Message::message_as<register_sgx::crash::Greeting>() const {
...
template <>
inline const register_sgx::crash::ProxyPutArgs *
Message::message_as<register_sgx::crash::ProxyPutArgs>() const {
...
inline flatbuffers::Offset<Message> CreateMessage(
    ...
    register_sgx::crash::MessageType type =
        register_sgx::crash::MessageType_client_greeting,
    int64_t ticket = 0,
...
inline bool VerifyBasicMessage(flatbuffers::Verifier &verifier, const void *obj,
    ...
    switch (type) {
        ...
        case BasicMessage_Greeting: {
            auto ptr =
                reinterpret_cast<const register_sgx::crash::Greeting *>(obj);
        ...
        case BasicMessage_ProxyPutArgs: {
            auto ptr =
                reinterpret_cast<const register_sgx::crash::ProxyPutArgs *>(
                    obj);
            return verifier.VerifyTable(ptr);
        }
