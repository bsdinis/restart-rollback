...
inline const MessageType (&EnumValuesMessageType())[15] {
    static const MessageType values[] = {
        MessageType_proxy_get_req,     MessageType_proxy_get_resp,
        MessageType_proxy_put_req,     MessageType_proxy_put_resp,
...
inline const char *const *EnumNamesMessageType() {
    static const char *const names[16] = {
        "proxy_get_req",     "proxy_get_resp",
        "proxy_put_req",     "proxy_put_resp",
        "get_req",           "get_resp",
        "get_timestamp_req", "get_timestamp_resp",
        "put_req",           "put_resp",
        "ping_req",          "ping_resp",
...
inline const char *EnumNameMessageType(MessageType e) {
    if (flatbuffers::IsOutRange(e, MessageType_proxy_get_req,
                                MessageType_close_req))
        return "";
...
inline flatbuffers::Offset<Message> CreateMessage(
    ...
    register_sgx::crash::MessageType type =
        register_sgx::crash::MessageType_proxy_get_req,
    int64_t ticket = 0,
