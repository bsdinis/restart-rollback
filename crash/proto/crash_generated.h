...
template<> struct BasicMessageTraits<register_sgx::crash::GetResult> {
  static const BasicMessage enum_value = BasicMessage_GetResult;
};

template<> struct BasicMessageTraits<register_sgx::crash::GetTimestampArgs> {
...
template<> struct BasicMessageTraits<register_sgx::crash::PutResult> {
  static const BasicMessage enum_value = BasicMessage_PutResult;
};

template<> struct BasicMessageTraits<register_sgx::crash::Empty> {
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  register_sgx::crash::MessageType type() const {
    return static_cast<register_sgx::crash::MessageType>(GetField<int8_t>(VT_TYPE, 0));
  }
  ...
  register_sgx::crash::BasicMessage message_type() const {
    return static_cast<register_sgx::crash::BasicMessage>(GetField<uint8_t>(VT_MESSAGE_TYPE, 0));
  }
  ...
  const register_sgx::crash::GetResult *message_as_GetResult() const {
    return message_type() == register_sgx::crash::BasicMessage_GetResult ? static_cast<const register_sgx::crash::GetResult *>(message()) : nullptr;
  }
  const register_sgx::crash::GetTimestampArgs *message_as_GetTimestampArgs() const {
    return message_type() == register_sgx::crash::BasicMessage_GetTimestampArgs ? static_cast<const register_sgx::crash::GetTimestampArgs *>(message()) : nullptr;
  }
  ...
  const register_sgx::crash::PutResult *message_as_PutResult() const {
    return message_type() == register_sgx::crash::BasicMessage_PutResult ? static_cast<const register_sgx::crash::PutResult *>(message()) : nullptr;
  }
  const register_sgx::crash::Empty *message_as_Empty() const {
    return message_type() == register_sgx::crash::BasicMessage_Empty ? static_cast<const register_sgx::crash::Empty *>(message()) : nullptr;
  }
...
template<> inline const register_sgx::crash::GetResult *Message::message_as<register_sgx::crash::GetResult>() const {
  return message_as_GetResult();
}

template<> inline const register_sgx::crash::GetTimestampArgs *Message::message_as<register_sgx::crash::GetTimestampArgs>() const {
...
template<> inline const register_sgx::crash::PutResult *Message::message_as<register_sgx::crash::PutResult>() const {
  return message_as_PutResult();
}

template<> inline const register_sgx::crash::Empty *Message::message_as<register_sgx::crash::Empty>() const {
...
inline bool VerifyBasicMessage(flatbuffers::Verifier &verifier, const void *obj, BasicMessage type) {
  switch (type) {
    ...
    case BasicMessage_GetResult: {
      auto ptr = reinterpret_cast<const register_sgx::crash::GetResult *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_GetTimestampArgs: {
      auto ptr = reinterpret_cast<const register_sgx::crash::GetTimestampArgs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    ...
    case BasicMessage_PutArgs: {
      auto ptr = reinterpret_cast<const register_sgx::crash::PutArgs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_PutResult: {
      auto ptr = reinterpret_cast<const register_sgx::crash::PutResult *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_Empty: {
      auto ptr = reinterpret_cast<const register_sgx::crash::Empty *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline const register_sgx::crash::Message *GetSizePrefixedMessage(const void *buf) {
...
inline bool VerifySizePrefixedMessageBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<register_sgx::crash::Message>(nullptr);
}
