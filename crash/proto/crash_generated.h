...
inline const MessageType (&EnumValuesMessageType())[9] {
  static const MessageType values[] = {
    MessageType_client_get_req,
    MessageType_client_get_resp,
    MessageType_client_put_req,
    MessageType_client_put_resp,
...
inline const char *EnumNameMessageType(MessageType e) {
  if (flatbuffers::IsOutRange(e, MessageType_client_get_req, MessageType_close_req)) return "";
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(1) Value FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Value() {
    memset(static_cast<void *>(this), 0, sizeof(Value));
  }
  const flatbuffers::Array<uint8_t, 2048> *data() const {
    return reinterpret_cast<const flatbuffers::Array<uint8_t, 2048> *>(data_);
  }
...
inline flatbuffers::Offset<Message> CreateMessage(
    flatbuffers::FlatBufferBuilder &_fbb,
    register_sgx::crash::MessageType type = register_sgx::crash::MessageType_client_get_req,
    int64_t ticket = 0,
