...
template<> struct BasicMessageTraits<paxos_sgx::crash::ClientFastGetResult> {
  static const BasicMessage enum_value = BasicMessage_ClientFastGetResult;
};

template<> struct BasicMessageTraits<paxos_sgx::crash::ReplicaFastGetResult> {
...
template<> struct BasicMessageTraits<paxos_sgx::crash::CloseArgs> {
...
struct CloseArgsBuilder {
  ...
  void add_shutdown(bool shutdown) {
    fbb_.AddElement<uint8_t>(CloseArgs::VT_SHUTDOWN, static_cast<uint8_t>(shutdown), 0);
  }
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const paxos_sgx::crash::ClientFastGetResult *message_as_ClientFastGetResult() const {
    return message_type() == paxos_sgx::crash::BasicMessage_ClientFastGetResult ? static_cast<const paxos_sgx::crash::ClientFastGetResult *>(message()) : nullptr;
  }
  const paxos_sgx::crash::ReplicaFastGetResult *message_as_ReplicaFastGetResult() const {
    return message_type() == paxos_sgx::crash::BasicMessage_ReplicaFastGetResult ? static_cast<const paxos_sgx::crash::ReplicaFastGetResult *>(message()) : nullptr;
  }
  ...
  const paxos_sgx::crash::CloseArgs *message_as_CloseArgs() const {
    return message_type() == paxos_sgx::crash::BasicMessage_CloseArgs ? static_cast<const paxos_sgx::crash::CloseArgs *>(message()) : nullptr;
  }
...
template<> inline const paxos_sgx::crash::ClientFastGetResult *Message::message_as<paxos_sgx::crash::ClientFastGetResult>() const {
  return message_as_ClientFastGetResult();
}

template<> inline const paxos_sgx::crash::ReplicaFastGetResult *Message::message_as<paxos_sgx::crash::ReplicaFastGetResult>() const {
...
template<> inline const paxos_sgx::crash::CloseArgs *Message::message_as<paxos_sgx::crash::CloseArgs>() const {
