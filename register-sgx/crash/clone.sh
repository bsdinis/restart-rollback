...
case "${ans}" in
    y|Y)
        ...
        sed -i -e 's/'${orig}'/'${target}'/g' .gitignore proto/*.fbs proto/*.sh clnt/Makefile clnt/*.cc clnt/*.h QP/sgxMakefile QP/Makefile QP/app/*.cc QP/app/*.h QP/enclave/*.cc QP/enclave/enclave.edl QP/enclave/*.h QP/include/*.h README.md clnt/README.md QP/README.md proto/README.md
