...
template <>
struct BasicMessageTraits<paxos_sgx::crash::FastGetArgs> {
...
template <>
struct BasicMessageTraits<paxos_sgx::crash::OperationArgs> {
    static const BasicMessage enum_value = BasicMessage_OperationArgs;
};

template <>
struct BasicMessageTraits<paxos_sgx::crash::OperationResult> {
    static const BasicMessage enum_value = BasicMessage_OperationResult;
};

template <>
struct BasicMessageTraits<paxos_sgx::crash::ReplicaPropose> {
    static const BasicMessage enum_value = BasicMessage_ReplicaPropose;
};

template <>
struct BasicMessageTraits<paxos_sgx::crash::ReplicaAccept> {
...
template <>
struct BasicMessageTraits<paxos_sgx::crash::Empty> {
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    paxos_sgx::crash::MessageType type() const {
        return static_cast<paxos_sgx::crash::MessageType>(
    ...
    paxos_sgx::crash::BasicMessage message_type() const {
        return static_cast<paxos_sgx::crash::BasicMessage>(
    ...
    const paxos_sgx::crash::FastGetArgs *message_as_FastGetArgs() const {
        return message_type() == paxos_sgx::crash::BasicMessage_FastGetArgs
                   ? static_cast<const paxos_sgx::crash::FastGetArgs *>(
                         message())
                   : nullptr;
    }
    ...
    const paxos_sgx::crash::OperationArgs *message_as_OperationArgs() const {
        return message_type() == paxos_sgx::crash::BasicMessage_OperationArgs
                   ? static_cast<const paxos_sgx::crash::OperationArgs *>(
                         message())
                   : nullptr;
    }
    const paxos_sgx::crash::OperationResult *message_as_OperationResult()
        const {
        return message_type() == paxos_sgx::crash::BasicMessage_OperationResult
                   ? static_cast<const paxos_sgx::crash::OperationResult *>(
                         message())
                   : nullptr;
    }
    const paxos_sgx::crash::ReplicaPropose *message_as_ReplicaPropose() const {
        return message_type() == paxos_sgx::crash::BasicMessage_ReplicaPropose
                   ? static_cast<const paxos_sgx::crash::ReplicaPropose *>(
                         message())
                   : nullptr;
    }
    const paxos_sgx::crash::ReplicaAccept *message_as_ReplicaAccept() const {
        return message_type() == paxos_sgx::crash::BasicMessage_ReplicaAccept
                   ? static_cast<const paxos_sgx::crash::ReplicaAccept *>(
                         message())
                   : nullptr;
    }
    const paxos_sgx::crash::ReplicaReject *message_as_ReplicaReject() const {
        return message_type() == paxos_sgx::crash::BasicMessage_ReplicaReject
                   ? static_cast<const paxos_sgx::crash::ReplicaReject *>(
                         message())
                   : nullptr;
    }
...
template <>
inline const paxos_sgx::crash::FastGetArgs *
Message::message_as<paxos_sgx::crash::FastGetArgs>() const {
...
Message::message_as<paxos_sgx::crash::OperationArgs>() const {
    return message_as_OperationArgs();
}

template <>
inline const paxos_sgx::crash::OperationResult *
Message::message_as<paxos_sgx::crash::OperationResult>() const {
    return message_as_OperationResult();
}

template <>
inline const paxos_sgx::crash::ReplicaPropose *
Message::message_as<paxos_sgx::crash::ReplicaPropose>() const {
    return message_as_ReplicaPropose();
}

template <>
inline const paxos_sgx::crash::ReplicaAccept *
Message::message_as<paxos_sgx::crash::ReplicaAccept>() const {
...
template <>
inline const paxos_sgx::crash::Empty *
Message::message_as<paxos_sgx::crash::Empty>() const {
...
inline flatbuffers::Offset<Message> CreateMessage(
    flatbuffers::FlatBufferBuilder &_fbb,
    paxos_sgx::crash::MessageType type =
        paxos_sgx::crash::MessageType_client_fast_get_req,
    int64_t ticket = 0,
    paxos_sgx::crash::BasicMessage message_type =
        paxos_sgx::crash::BasicMessage_NONE,
...
inline bool VerifyBasicMessage(flatbuffers::Verifier &verifier, const void *obj,
    ...
    switch (type) {
        ...
        case BasicMessage_OperationResult: {
            auto ptr =
                reinterpret_cast<const paxos_sgx::crash::OperationResult *>(
                    obj);
            return verifier.VerifyTable(ptr);
        }
        case BasicMessage_ReplicaPropose: {
            auto ptr =
                reinterpret_cast<const paxos_sgx::crash::ReplicaPropose *>(obj);
            return verifier.VerifyTable(ptr);
        }
        case BasicMessage_ReplicaAccept: {
            auto ptr =
                reinterpret_cast<const paxos_sgx::crash::ReplicaAccept *>(obj);
            return verifier.VerifyTable(ptr);
        }
...
inline const paxos_sgx::crash::Message *GetSizePrefixedMessage(
    const void *buf) {
...
inline bool VerifySizePrefixedMessageBuffer(flatbuffers::Verifier &verifier) {
    return verifier.VerifySizePrefixedBuffer<paxos_sgx::crash::Message>(
        nullptr);
}
