...
set output 'pbft/png/full_throughput.png'
...
set xrange [0:*]
set yrange [0:*]
plot 'pbft/dat/read_throughput.dat' title 'Read' with yerrorbars linestyle 3, '' notitle with lines linestyle 2, 'pbft/dat/write_throughput.dat' title 'Write' with yerrorbars linestyle 5, '' notitle with lines linestyle 4
