...
set output 'crash/png/latency.png'
...
set xrange [0:*]
set yrange [0:*]
plot 'crash/dat/read_lat.dat' title 'Read' with yerrorbars linestyle 3, '' notitle with lines linestyle 2, 'crash/dat/write_lat.dat' title 'Write' with yerrorbars linestyle 5, '' notitle with lines linestyle 4
