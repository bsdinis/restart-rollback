...
set output 'r2/png/full_throughput.png'
...
set xrange [0:*]
set yrange [0:*]
plot 'r2/dat/read_throughput.dat' title 'Read' with yerrorbars linestyle 3, '' notitle with lines linestyle 2, 'r2/dat/write_throughput.dat' title 'Write' with yerrorbars linestyle 5, '' notitle with lines linestyle 4
