...
for i in {1..7};
do
    ssh root@sgx0$i '/home/bdinisa/dev/sigilum/add_lat/add_lat.sh bond0 1ms 0.5ms'
done
ssh root@sigilium02 '/home/bdinisa/dev/sigilum/add_lat/add_lat.sh bond0 1ms 0.5ms'
