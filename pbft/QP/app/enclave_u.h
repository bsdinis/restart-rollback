...
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_start_enclave_report, (const char* str));
#endif
...
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_sgx_connect_block, (int* socket, const char* addr, uint16_t port));
#endif
...
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_log, (const char* file, int line, const char* str));
#endif
#ifndef OCALL_BUILD_ADDR_DEFINED__
#define OCALL_BUILD_ADDR_DEFINED__
void* SGX_UBRIDGE(SGX_NOCONVENTION, ocall_build_addr, (uint16_t port, const char* ip_addr));
#endif
#ifndef OCALL_NET_START_LISTEN_SOCKET_DEFINED__
#define OCALL_NET_START_LISTEN_SOCKET_DEFINED__
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_net_start_listen_socket, (const char* server_addr, uint16_t server_port));
#endif
#ifndef OCALL_NET_GET_MY_IPV4_ADDR_DEFINED__
#define OCALL_NET_GET_MY_IPV4_ADDR_DEFINED__
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_net_get_my_ipv4_addr, (char* addr, size_t sz));
#endif
...
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_select_list, (selected_t* list, ssize_t list_sz));
#endif
...
sgx_status_t pbft_enclave_start(sgx_enclave_id_t eid, config_t conf, ssize_t my_idx, void* mmaped_addr, size_t addr_size, void* measure_buffer, size_t buffer_size);
