...
#ifndef FLATBUFFERS_GENERATED_RESTARTROLLBACK_PAXOS_SGX_RESTART_ROLLBACK_H_
#define FLATBUFFERS_GENERATED_RESTARTROLLBACK_PAXOS_SGX_RESTART_ROLLBACK_H_
...
template<> struct BasicMessageTraits<paxos_sgx::restart_rollback::FastGetArgs> {
  static const BasicMessage enum_value = BasicMessage_FastGetArgs;
};

template<> struct BasicMessageTraits<paxos_sgx::restart_rollback::FastGetResult> {
  static const BasicMessage enum_value = BasicMessage_FastGetResult;
};

template<> struct BasicMessageTraits<paxos_sgx::restart_rollback::OperationArgs> {
  static const BasicMessage enum_value = BasicMessage_OperationArgs;
};

template<> struct BasicMessageTraits<paxos_sgx::restart_rollback::OperationResult> {
  static const BasicMessage enum_value = BasicMessage_OperationResult;
};

template<> struct BasicMessageTraits<paxos_sgx::restart_rollback::ReplicaPropose> {
  static const BasicMessage enum_value = BasicMessage_ReplicaPropose;
};

template<> struct BasicMessageTraits<paxos_sgx::restart_rollback::ReplicaAccept> {
  static const BasicMessage enum_value = BasicMessage_ReplicaAccept;
};

template<> struct BasicMessageTraits<paxos_sgx::restart_rollback::ReplicaReject> {
  static const BasicMessage enum_value = BasicMessage_ReplicaReject;
};

template<> struct BasicMessageTraits<paxos_sgx::restart_rollback::Empty> {
...
struct ReplicaProposeBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_operation_args(flatbuffers::Offset<paxos_sgx::restart_rollback::OperationArgs> operation_args) {
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  paxos_sgx::restart_rollback::MessageType type() const {
    return static_cast<paxos_sgx::restart_rollback::MessageType>(GetField<int8_t>(VT_TYPE, 0));
  }
  int64_t ticket() const {
    return GetField<int64_t>(VT_TICKET, 0);
  }
  paxos_sgx::restart_rollback::BasicMessage message_type() const {
    return static_cast<paxos_sgx::restart_rollback::BasicMessage>(GetField<uint8_t>(VT_MESSAGE_TYPE, 0));
  }
  const void *message() const {
    return GetPointer<const void *>(VT_MESSAGE);
  }
  template<typename T> const T *message_as() const;
  const paxos_sgx::restart_rollback::FastGetArgs *message_as_FastGetArgs() const {
    return message_type() == paxos_sgx::restart_rollback::BasicMessage_FastGetArgs ? static_cast<const paxos_sgx::restart_rollback::FastGetArgs *>(message()) : nullptr;
  }
  const paxos_sgx::restart_rollback::FastGetResult *message_as_FastGetResult() const {
    return message_type() == paxos_sgx::restart_rollback::BasicMessage_FastGetResult ? static_cast<const paxos_sgx::restart_rollback::FastGetResult *>(message()) : nullptr;
  }
  const paxos_sgx::restart_rollback::OperationArgs *message_as_OperationArgs() const {
    return message_type() == paxos_sgx::restart_rollback::BasicMessage_OperationArgs ? static_cast<const paxos_sgx::restart_rollback::OperationArgs *>(message()) : nullptr;
  }
  const paxos_sgx::restart_rollback::OperationResult *message_as_OperationResult() const {
    return message_type() == paxos_sgx::restart_rollback::BasicMessage_OperationResult ? static_cast<const paxos_sgx::restart_rollback::OperationResult *>(message()) : nullptr;
  }
  const paxos_sgx::restart_rollback::ReplicaPropose *message_as_ReplicaPropose() const {
    return message_type() == paxos_sgx::restart_rollback::BasicMessage_ReplicaPropose ? static_cast<const paxos_sgx::restart_rollback::ReplicaPropose *>(message()) : nullptr;
  }
  const paxos_sgx::restart_rollback::ReplicaAccept *message_as_ReplicaAccept() const {
    return message_type() == paxos_sgx::restart_rollback::BasicMessage_ReplicaAccept ? static_cast<const paxos_sgx::restart_rollback::ReplicaAccept *>(message()) : nullptr;
  }
  const paxos_sgx::restart_rollback::ReplicaReject *message_as_ReplicaReject() const {
    return message_type() == paxos_sgx::restart_rollback::BasicMessage_ReplicaReject ? static_cast<const paxos_sgx::restart_rollback::ReplicaReject *>(message()) : nullptr;
  }
  const paxos_sgx::restart_rollback::Empty *message_as_Empty() const {
    return message_type() == paxos_sgx::restart_rollback::BasicMessage_Empty ? static_cast<const paxos_sgx::restart_rollback::Empty *>(message()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const paxos_sgx::restart_rollback::FastGetArgs *Message::message_as<paxos_sgx::restart_rollback::FastGetArgs>() const {
  return message_as_FastGetArgs();
}

template<> inline const paxos_sgx::restart_rollback::FastGetResult *Message::message_as<paxos_sgx::restart_rollback::FastGetResult>() const {
  return message_as_FastGetResult();
}

template<> inline const paxos_sgx::restart_rollback::OperationArgs *Message::message_as<paxos_sgx::restart_rollback::OperationArgs>() const {
  return message_as_OperationArgs();
}

template<> inline const paxos_sgx::restart_rollback::OperationResult *Message::message_as<paxos_sgx::restart_rollback::OperationResult>() const {
  return message_as_OperationResult();
}

template<> inline const paxos_sgx::restart_rollback::ReplicaPropose *Message::message_as<paxos_sgx::restart_rollback::ReplicaPropose>() const {
  return message_as_ReplicaPropose();
}

template<> inline const paxos_sgx::restart_rollback::ReplicaAccept *Message::message_as<paxos_sgx::restart_rollback::ReplicaAccept>() const {
  return message_as_ReplicaAccept();
}

template<> inline const paxos_sgx::restart_rollback::ReplicaReject *Message::message_as<paxos_sgx::restart_rollback::ReplicaReject>() const {
  return message_as_ReplicaReject();
}

template<> inline const paxos_sgx::restart_rollback::Empty *Message::message_as<paxos_sgx::restart_rollback::Empty>() const {
...
struct MessageBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_type(paxos_sgx::restart_rollback::MessageType type) {
  ...
  void add_message_type(paxos_sgx::restart_rollback::BasicMessage message_type) {
...
inline flatbuffers::Offset<Message> CreateMessage(
    flatbuffers::FlatBufferBuilder &_fbb,
    paxos_sgx::restart_rollback::MessageType type = paxos_sgx::restart_rollback::MessageType_client_fast_get_req,
    int64_t ticket = 0,
    paxos_sgx::restart_rollback::BasicMessage message_type = paxos_sgx::restart_rollback::BasicMessage_NONE,
...
inline bool VerifyBasicMessage(flatbuffers::Verifier &verifier, const void *obj, BasicMessage type) {
  switch (type) {
    ...
    case BasicMessage_FastGetArgs: {
      auto ptr = reinterpret_cast<const paxos_sgx::restart_rollback::FastGetArgs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_FastGetResult: {
      auto ptr = reinterpret_cast<const paxos_sgx::restart_rollback::FastGetResult *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_OperationArgs: {
      auto ptr = reinterpret_cast<const paxos_sgx::restart_rollback::OperationArgs *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_OperationResult: {
      auto ptr = reinterpret_cast<const paxos_sgx::restart_rollback::OperationResult *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_ReplicaPropose: {
      auto ptr = reinterpret_cast<const paxos_sgx::restart_rollback::ReplicaPropose *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_ReplicaAccept: {
      auto ptr = reinterpret_cast<const paxos_sgx::restart_rollback::ReplicaAccept *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_ReplicaReject: {
      auto ptr = reinterpret_cast<const paxos_sgx::restart_rollback::ReplicaReject *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case BasicMessage_Empty: {
      auto ptr = reinterpret_cast<const paxos_sgx::restart_rollback::Empty *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline const paxos_sgx::restart_rollback::Message *GetMessage(const void *buf) {
  return flatbuffers::GetRoot<paxos_sgx::restart_rollback::Message>(buf);
}

inline const paxos_sgx::restart_rollback::Message *GetSizePrefixedMessage(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<paxos_sgx::restart_rollback::Message>(buf);
}

inline bool VerifyMessageBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<paxos_sgx::restart_rollback::Message>(nullptr);
}

inline bool VerifySizePrefixedMessageBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<paxos_sgx::restart_rollback::Message>(nullptr);
}

inline void FinishMessageBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<paxos_sgx::restart_rollback::Message> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_RESTARTROLLBACK_PAXOS_SGX_RESTART_ROLLBACK_H_
