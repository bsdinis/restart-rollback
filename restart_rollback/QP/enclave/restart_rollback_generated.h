...
template <>
struct BasicMessageTraits<register_sgx::restart_rollback::Greeting> {
    static const BasicMessage enum_value = BasicMessage_Greeting;
};

template <>
struct BasicMessageTraits<register_sgx::restart_rollback::GetArgs> {
    static const BasicMessage enum_value = BasicMessage_GetArgs;
};

template <>
struct BasicMessageTraits<register_sgx::restart_rollback::GetResult> {
    static const BasicMessage enum_value = BasicMessage_GetResult;
};

template <>
struct BasicMessageTraits<register_sgx::restart_rollback::GetTimestampArgs> {
    static const BasicMessage enum_value = BasicMessage_GetTimestampArgs;
};

template <>
struct BasicMessageTraits<register_sgx::restart_rollback::GetTimestampResult> {
    static const BasicMessage enum_value = BasicMessage_GetTimestampResult;
};

template <>
struct BasicMessageTraits<register_sgx::restart_rollback::ProxyPutArgs> {
    static const BasicMessage enum_value = BasicMessage_ProxyPutArgs;
};

template <>
struct BasicMessageTraits<register_sgx::restart_rollback::PutArgs> {
...
template <>
struct BasicMessageTraits<register_sgx::restart_rollback::Empty> {
...
struct GetResult FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const register_sgx::restart_rollback::Value *value() const {
        return GetStruct<const register_sgx::restart_rollback::Value *>(
            VT_VALUE);
    }
...
struct GetTimestampResultBuilder {
    ...
    void add_suspicious(bool suspicious) {
        fbb_.AddElement<uint8_t>(GetTimestampResult::VT_SUSPICIOUS,
                                 static_cast<uint8_t>(suspicious), 0);
    }
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    register_sgx::restart_rollback::MessageType type() const {
        return static_cast<register_sgx::restart_rollback::MessageType>(
    ...
    register_sgx::restart_rollback::BasicMessage message_type() const {
        return static_cast<register_sgx::restart_rollback::BasicMessage>(
    ...
    const register_sgx::restart_rollback::Greeting *message_as_Greeting()
        const {
        return message_type() ==
                       register_sgx::restart_rollback::BasicMessage_Greeting
                   ? static_cast<
                         const register_sgx::restart_rollback::Greeting *>(
                         message())
                   : nullptr;
    }
    const register_sgx::restart_rollback::GetArgs *message_as_GetArgs() const {
        return message_type() ==
                       register_sgx::restart_rollback::BasicMessage_GetArgs
                   ? static_cast<
                         const register_sgx::restart_rollback::GetArgs *>(
                         message())
                   : nullptr;
    }
    const register_sgx::restart_rollback::GetResult *message_as_GetResult()
        const {
        return message_type() ==
                       register_sgx::restart_rollback::BasicMessage_GetResult
                   ? static_cast<
                         const register_sgx::restart_rollback::GetResult *>(
                         message())
                   : nullptr;
    }
    const register_sgx::restart_rollback::GetTimestampArgs *
    message_as_GetTimestampArgs() const {
        return message_type() == register_sgx::restart_rollback::
                                     BasicMessage_GetTimestampArgs
                   ? static_cast<const register_sgx::restart_rollback::
                                     GetTimestampArgs *>(message())
                   : nullptr;
    }
    const register_sgx::restart_rollback::GetTimestampResult *
    message_as_GetTimestampResult() const {
        return message_type() == register_sgx::restart_rollback::
                                     BasicMessage_GetTimestampResult
                   ? static_cast<const register_sgx::restart_rollback::
                                     GetTimestampResult *>(message())
                   : nullptr;
    }
    const register_sgx::restart_rollback::ProxyPutArgs *
    message_as_ProxyPutArgs() const {
        return message_type() ==
                       register_sgx::restart_rollback::BasicMessage_ProxyPutArgs
                   ? static_cast<
                         const register_sgx::restart_rollback::ProxyPutArgs *>(
                         message())
                   : nullptr;
    ...
    const register_sgx::restart_rollback::PutArgs *message_as_PutArgs() const {
        return message_type() ==
                       register_sgx::restart_rollback::BasicMessage_PutArgs
                   ? static_cast<
                         const register_sgx::restart_rollback::PutArgs *>(
                         message())
                   : nullptr;
    }
    const register_sgx::restart_rollback::PutResult *message_as_PutResult()
        const {
        return message_type() ==
                       register_sgx::restart_rollback::BasicMessage_PutResult
                   ? static_cast<
                         const register_sgx::restart_rollback::PutResult *>(
                         message())
                   : nullptr;
    }
    const register_sgx::restart_rollback::Empty *message_as_Empty() const {
        return message_type() ==
                   ...
                   ? static_cast<const register_sgx::restart_rollback::Empty *>(
                         message())
                   : nullptr;
    }
...
template <>
inline const register_sgx::restart_rollback::Greeting *
Message::message_as<register_sgx::restart_rollback::Greeting>() const {
    return message_as_Greeting();
}

template <>
inline const register_sgx::restart_rollback::GetArgs *
Message::message_as<register_sgx::restart_rollback::GetArgs>() const {
    return message_as_GetArgs();
}

template <>
inline const register_sgx::restart_rollback::GetResult *
Message::message_as<register_sgx::restart_rollback::GetResult>() const {
    return message_as_GetResult();
}

template <>
inline const register_sgx::restart_rollback::GetTimestampArgs *
Message::message_as<register_sgx::restart_rollback::GetTimestampArgs>() const {
    return message_as_GetTimestampArgs();
}

template <>
inline const register_sgx::restart_rollback::GetTimestampResult *
Message::message_as<register_sgx::restart_rollback::GetTimestampResult>()
    const {
    return message_as_GetTimestampResult();
}

template <>
inline const register_sgx::restart_rollback::ProxyPutArgs *
Message::message_as<register_sgx::restart_rollback::ProxyPutArgs>() const {
    return message_as_ProxyPutArgs();
}

template <>
inline const register_sgx::restart_rollback::PutArgs *
Message::message_as<register_sgx::restart_rollback::PutArgs>() const {
...
template <>
inline const register_sgx::restart_rollback::Empty *
Message::message_as<register_sgx::restart_rollback::Empty>() const {
...
struct MessageBuilder {
    ...
    void add_message_type(
        register_sgx::restart_rollback::BasicMessage message_type) {
...
inline flatbuffers::Offset<Message> CreateMessage(
    flatbuffers::FlatBufferBuilder &_fbb,
    register_sgx::restart_rollback::MessageType type =
        register_sgx::restart_rollback::MessageType_client_greeting,
    int64_t ticket = 0,
    register_sgx::restart_rollback::BasicMessage message_type =
        register_sgx::restart_rollback::BasicMessage_NONE,
    ...
    switch (type) {
        ...
        case BasicMessage_Greeting: {
            auto ptr = reinterpret_cast<
                const register_sgx::restart_rollback::Greeting *>(obj);
            return verifier.VerifyTable(ptr);
        }
        case BasicMessage_GetArgs: {
            auto ptr = reinterpret_cast<
                const register_sgx::restart_rollback::GetArgs *>(obj);
            return verifier.VerifyTable(ptr);
        }
        case BasicMessage_GetResult: {
            auto ptr = reinterpret_cast<
                const register_sgx::restart_rollback::GetResult *>(obj);
            return verifier.VerifyTable(ptr);
        }
        case BasicMessage_GetTimestampArgs: {
            auto ptr = reinterpret_cast<
                const register_sgx::restart_rollback::GetTimestampArgs *>(obj);
            return verifier.VerifyTable(ptr);
        }
        ...
        case BasicMessage_ProxyPutArgs: {
            auto ptr = reinterpret_cast<
                const register_sgx::restart_rollback::ProxyPutArgs *>(obj);
            return verifier.VerifyTable(ptr);
        }
        case BasicMessage_PutArgs: {
            auto ptr = reinterpret_cast<
                const register_sgx::restart_rollback::PutArgs *>(obj);
            return verifier.VerifyTable(ptr);
        }
        ...
        case BasicMessage_Empty: {
            auto ptr =
                reinterpret_cast<const register_sgx::restart_rollback::Empty *>(
                    obj);
            return verifier.VerifyTable(ptr);
        }
        default:
...
inline const register_sgx::restart_rollback::Message *GetMessage(
    const void *buf) {
    return flatbuffers::GetRoot<register_sgx::restart_rollback::Message>(buf);
}

inline const register_sgx::restart_rollback::Message *GetSizePrefixedMessage(
    const void *buf) {
    return flatbuffers::GetSizePrefixedRoot<
        register_sgx::restart_rollback::Message>(buf);
}
...
inline bool VerifyMessageBuffer(flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<register_sgx::restart_rollback::Message>(
        nullptr);
}

inline bool VerifySizePrefixedMessageBuffer(flatbuffers::Verifier &verifier) {
    return verifier
        .VerifySizePrefixedBuffer<register_sgx::restart_rollback::Message>(
            nullptr);
}
