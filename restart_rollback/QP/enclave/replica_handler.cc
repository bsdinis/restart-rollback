...
int broadcast_accept(int64_t ticket,
    ...
    auto accept = paxos_sgx::restart_rollback::CreateReplicaAccept(
        builder, message->slot_number(), sus);
    auto msg = paxos_sgx::restart_rollback::CreateMessage(
        builder, paxos_sgx::restart_rollback::MessageType_replica_accept,
        ticket, paxos_sgx::restart_rollback::BasicMessage_ReplicaAccept,
        accept.Union());
    builder.Finish(msg);
...
int broadcast_reject(
    int64_t ticket,
    paxos_sgx::restart_rollback::ReplicaPropose const *message) {
    flatbuffers::FlatBufferBuilder builder;
    auto reject = paxos_sgx::restart_rollback::CreateReplicaReject(
        builder, message->slot_number());
    auto msg = paxos_sgx::restart_rollback::CreateMessage(
        builder, paxos_sgx::restart_rollback::MessageType_replica_reject,
        ticket, paxos_sgx::restart_rollback::BasicMessage_ReplicaReject,
        reject.Union());
    builder.Finish(msg);
