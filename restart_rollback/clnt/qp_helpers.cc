...
int64_t send_get_request(int64_t key, call_type type) {
    ...
    auto get_args = register_sgx::restart_rollback::CreateGetArgs(builder, key);
...
int64_t send_get_timestamp_request(int64_t key, call_type type) {
    ...
    flatbuffers::FlatBufferBuilder builder;
    auto get_args =
        register_sgx::restart_rollback::CreateGetTimestampArgs(builder, key);
...
int64_t send_proxy_get_request(peer &server, int64_t key, call_type type) {
    ...
    auto request = register_sgx::restart_rollback::CreateMessage(
        builder, register_sgx::restart_rollback::MessageType_proxy_get_req,
        ticket, register_sgx::restart_rollback::BasicMessage_GetArgs,
        get_args.Union());
    builder.Finish(request);
...
int64_t send_proxy_put_request(peer &server, int64_t key,
    ...
    auto put_args = register_sgx::restart_rollback::CreateProxyPutArgs(
        builder, key, &fb_value, g_client_id);

    auto request = register_sgx::restart_rollback::CreateMessage(
        builder, register_sgx::restart_rollback::MessageType_proxy_put_req,
        ticket, register_sgx::restart_rollback::BasicMessage_ProxyPutArgs,
        put_args.Union());
    builder.Finish(request);
...
int64_t send_ping_request(peer &server, call_type type) {
    ...
    flatbuffers::FlatBufferBuilder builder;
    auto ping_args = register_sgx::restart_rollback::CreateEmpty(builder);

    auto request = register_sgx::restart_rollback::CreateMessage(
        builder, register_sgx::restart_rollback::MessageType_ping_req, ticket,
        register_sgx::restart_rollback::BasicMessage_Empty, ping_args.Union());
    builder.Finish(request);
...
int64_t send_reset_request(peer &server, call_type type) {
    ...
    flatbuffers::FlatBufferBuilder builder;
    auto reset_args = register_sgx::restart_rollback::CreateEmpty(builder);

    auto request = register_sgx::restart_rollback::CreateMessage(
        builder, register_sgx::restart_rollback::MessageType_reset_req, ticket,
        register_sgx::restart_rollback::BasicMessage_Empty, reset_args.Union());
    builder.Finish(request);
...
int handle_received_message(size_t idx, peer &p) {
    ...
    while (p.buffer().size() > 0) {
        ...
        auto response = register_sgx::restart_rollback::GetMessage(
            p.buffer().data() + sizeof(size_t));

        switch (response->type()) {
            case register_sgx::restart_rollback::MessageType_client_greeting:
            ...
            case register_sgx::restart_rollback::MessageType_put_resp:
                ...
                break;
            case register_sgx::restart_rollback::MessageType_proxy_get_resp:
                ...
                proxy_get_handler(
                    ...
                    response->message_as_GetResult()->timestamp());
                break;
            case register_sgx::restart_rollback::MessageType_proxy_put_resp:
            ...
            case register_sgx::restart_rollback::MessageType_ping_resp:
                ...
                break;
            case register_sgx::restart_rollback::MessageType_reset_resp:
