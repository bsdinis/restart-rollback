...
int64_t gen_metadata_ticket(int64_t teems_ticket, uint8_t call_number, bool independent, call_type type);
int64_t gen_untrusted_ticket(int64_t teems_ticket, uint8_t call_number, bool independent, call_type type);
