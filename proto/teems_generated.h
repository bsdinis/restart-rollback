...
template<> struct BasicMessageTraits<teems::ChangePolicyArgs> {
...
struct ChangePolicyArgs FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint8_t policy_code() const {
    return GetField<uint8_t>(VT_POLICY_CODE, 0);
  }
...
struct ChangePolicyArgsBuilder {
  ...
  void add_policy_code(uint8_t policy_code) {
    fbb_.AddElement<uint8_t>(ChangePolicyArgs::VT_POLICY_CODE, policy_code, 0);
  }
  void add_client_id(int32_t client_id) {
...
struct ChangePolicyResultBuilder {
  ...
  void add_success(bool success) {
    fbb_.AddElement<uint8_t>(ChangePolicyResult::VT_SUCCESS, static_cast<uint8_t>(success), 0);
  }
  void add_policy_version(int64_t policy_version) {
...
struct Message FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const teems::ChangePolicyArgs *message_as_ChangePolicyArgs() const {
    return message_type() == teems::BasicMessage_ChangePolicyArgs ? static_cast<const teems::ChangePolicyArgs *>(message()) : nullptr;
  }
...
template<> inline const teems::ChangePolicyArgs *Message::message_as<teems::ChangePolicyArgs>() const {
